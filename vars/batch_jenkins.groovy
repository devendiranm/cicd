...
//						-Dsonar.projectKey=BATCH_MASTER \
...
//         			{
//						sh '''$SCANNER_HOME/bin/sonar-scanner \
//						-Dsonar.projectKey=BATCH_RELEASE \
//						-Dsonar.java.binaries=target/classes/ \
//             			-Dsonar.sources=src/main/java/'''
//					}
//                }
...
//         			{
//						sh '''$SCANNER_HOME/bin/sonar-scanner \
//						-Dsonar.projectKey=BATCH_DEVELOPMENT \
//						-Dsonar.java.binaries=target/classes/ \
//             			-Dsonar.sources=src/main/java/'''
//					}
//                }
...
//         			{
//						sh '''$SCANNER_HOME/bin/sonar-scanner \
//						-Dsonar.projectKey=BATCH_FEATURE \
//						-Dsonar.java.binaries=target/classes/ \
//             			-Dsonar.sources=src/main/java/'''
//					}
//                }
//            }
            stage("Uploading master JAR file to Nexus")
			{
        		...
        		steps
				{
					nexusArtifactUploader(
							artifacts: [artifactId: "${env.BRANCH_NAME}",classifier: '', file: "binconfig.jar", type: "jar" ],
          	...
          	stage("Uploading Relese WAR file to Nexus")
			{
            	when
				{
              	...
              	{
        			nexusArtifactUploader(
							artifacts: [artifactId: "${branch_type}",classifier: '', file: "binconfig.jar", type: "jar" ],
                		credentialsId: 'd9f3ff8c-9dd2-4233-856f-db2921861c1a',
                		groupId: "${bitbucket_repo}",
                		nexusUrl: (pipelineParams.nexus_url),
                		nexusVersion: 'nexus3',
