...
//						-Dsonar.projectKey=ALLIED_MASTER \
...
//         			{
//						sh '''$SCANNER_HOME/bin/sonar-scanner \
//						-Dsonar.projectKey=ALLIED_RELEASE \
//						-Dsonar.java.binaries=target/classes/ \
//             			-Dsonar.sources=src/main/java/'''
//					}
//                }
...
//         			{
//						sh '''$SCANNER_HOME/bin/sonar-scanner \
//						-Dsonar.projectKey=ALLIED_DEVELOPMENT \
//						-Dsonar.java.binaries=target/classes/ \
//             			-Dsonar.sources=src/main/java/'''
//					}
//                }
...
//         			{
//						sh '''$SCANNER_HOME/bin/sonar-scanner \
//						-Dsonar.projectKey=ALLIED_FEATURE \
//						-Dsonar.java.binaries=target/classes/ \
//             			-Dsonar.sources=src/main/java/'''
//					}
//                }
        		...
        		steps
				{
					nexusArtifactUploader(
                		...
                		repository: (pipelineParams.nexus_prod_repo),
                      	version: "${env.BRANCH_NAME}-allied"
					)
           		}
            }
